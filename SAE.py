### get from https://github.com/eleozzr/desc/blob/master/desc/models/SAE.py
### use the stack autoencoder to train the weight and use the weight in autoencoder
...
class SAE(object):
    ...
    def pretrain_autoencoders(self, x, epochs=500):
        ...
        :return: 
        """
        print("Doing SAE: pretrain_autoencoders")  
